<h1 class="mt-4">Ubah Pinjaman Buku</h1>
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <form method="post">
                    <?php
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if ($query) {
                                ...
                                echo '<script>alert("Gagal Mengubah Peminjaman: ' . mysqli_error($koneksi) . '");</script>';
                            }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <!-- Tombol Kembali untuk kembali ke halaman peminjaman -->
